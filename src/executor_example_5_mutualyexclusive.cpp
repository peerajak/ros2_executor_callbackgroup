/*
4.11   Mutually Exclusive Callback Groups
MutuallyExclusiveCallbackGroup allows the Executor to execute only one of its
Callbacks simultaneously, essentially making it as if a SingleThreadedExecutor
executed the Callbacks in the group. Thus, it is a good choice to put any
Callbacks accessing critical and potentially non-thread-safe resources in the
same MutuallyExclusiveCallbackGroup.
*/
